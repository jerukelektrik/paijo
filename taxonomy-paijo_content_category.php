	...
	<div class="paijo-container">
		...
		<div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-10 border-b border-neutral-100 dark:border-neutral-800/60 pb-8">
			<div class="max-w-3xl">
				...
				<h1 class="text-3xl sm:text-4xl lg:text-5xl font-sans font-extrabold text-paijo-ink leading-tight"><?php echo esc_html( $current_term->name ); ?></h1>
				<?php if ( ! empty( $current_term->description ) ) : ?>
					<div class="mt-4 text-paijo-muted text-sm sm:text-base leading-relaxed"><?php echo esc_html( $current_term->description ); ?></div>
				<?php endif; ?>
			</div>
