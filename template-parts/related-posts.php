...
<section class="mt-14 border-t border-paijo-line pt-8">
	<div class="mb-6">
	...
	<div class="space-y-4">
		...
		while ( $related->have_posts() ) :
			...
			?>
			<div class="flex items-center justify-between gap-4 p-4 sm:p-5 rounded-xl bg-[#F8F9FA] dark:bg-neutral-900 border border-transparent hover:bg-[#F1F3F5] dark:hover:bg-neutral-800/80 transition-all duration-200">
				<!-- Left content -->
				<div class="flex-1 min-w-0">
					<!-- Title -->
					<h3 class="font-sans font-extrabold text-sm sm:text-base text-paijo-ink leading-snug mb-3 line-clamp-2">
					...
					<!-- Author & Meta -->
					<div class="flex items-center gap-2 text-xs text-paijo-muted">
						<!-- Author Avatar -->
						<img class="w-5 h-5 rounded-full object-cover bg-neutral-200 border border-paijo-line" src="<?php echo esc_url( get_avatar_url( get_the_author_meta( 'ID' ), 40 ) ); ?>" alt="<?php echo esc_attr( get_the_author() ); ?>">
						
						<!-- Author Name -->
						<a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" class="font-bold text-paijo-ink hover:text-paijo-accent transition-colors">
							<?php echo esc_html( get_the_author() ); ?>
						</a>

						<!-- Verified Check icon (Blue circular checkmark) -->
						<span class="inline-flex items-center" title="Verified Creator">
